    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="product-grid">
                <a href="product_details.php" class="product-card" data-category="unisex gray nike-c1ty-gray">
                ...
                <a href="product_details.php" class="product-card" data-category="men black nike-c1ty-black">
                    <img src="images/anh1.png" alt="Nike C1TY Pink">
                    <h2>Nike C1TY Pink</h2>
                    <p> 2,929,000₫</p>
                </a>
                <a href="product_details.php" class="product-card" data-category="women blue nike-c1ty-blue">
                    <img src="images/anh2.png" alt="Nike C1TY Black">
                    <h2>Nike C1TY Black</h2>
                    <p> 2,299,000₫</p>
                </a>
                <a href="product_details.php" class="product-card" data-category="men brown nike-c1ty">
